import { termsSections } from '../data/index.js';

export function Terms() {
  return (
    <div style={{ maxWidth: 760 }}>
      <h1 style={{ fontFamily: 'var(--serif)', fontSize: 30, letterSpacing: '-.02em', margin: '0 0 6px' }}>Terms of service</h1>
      <p style={{ fontSize: 13.5, color: 'rgba(194,240,234,.55)', margin: '0 0 24px' }}>Please read before using ClinicalMind for study.</p>
